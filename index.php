...
<body>
    ...
    <div id="white-background" style="background-color: white; overflow: hidden; height: 100px;">
        <h1>Información adicional</h1>
        <p>Esta es información adicional que se mostrará debajo de las tarjetas.</p>
    </div>
    <div class="cards2">
        <div class="row g-0 bg-body-secondary position-relative">
            <div class="col-md-6 mb-md0 p-md-4">
                <img src="" class="w-100" alt="...">
                <p>Información de la dueña</p>
                <ul style="text-align: center;">
                    <li>Nombre: María José</li>
                    <li>Teléfono: 123-456-789</li>
                    <li>Correo electrónico: mariajose@example.com</li>
                </ul>
            </div>
        </div>
    </div>
